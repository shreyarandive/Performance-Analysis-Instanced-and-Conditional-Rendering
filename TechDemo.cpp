...
//SHADER 1
static const std::string vertex_shader("occlusion_vs.glsl");
static const std::string fragment_shader("occlusion_fs.glsl");
...
//SHADER 2
static const std::string vertex_shader_2("instanced_vs.glsl");
static const std::string fragment_shader_2("instanced_fs.glsl");
...
//SHADER 3
static const std::string vertex_shader_3("cube_map_vs.glsl");
static const std::string fragment_shader_3("cube_map_fs.glsl");
...
//SHADER 4
static const std::string vertex_shader_4("particle_vs.glsl");
static const std::string fragment_shader_4("particle_fs.glsl");
